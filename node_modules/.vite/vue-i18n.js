    ...
    SourceNode.fromStringWithSourceMap = function SourceNode_fromStringWithSourceMap(aGeneratedCode, aSourceMapConsumer, aRelativePath) {
      ...
      function addMappingWithCode(mapping, code3) {
        if (mapping === null || mapping.source === void 0) {
          ...
          node.add(new SourceNode(mapping.originalLine, mapping.originalColumn, source, code3, mapping.name));
        }
      }
    };
...
function createCodeGenerator(ast, options) {
  ...
  function push(code3, node) {
    ...
    if (_context.map) {
      ...
      advancePositionWithSource(_context, code3);
    }
  }
  ...
  if (sourceMap) {
    _context.map = new import_source_map.SourceMapGenerator();
...
/*!
  ...
  */
/*!
  * shared v9.2.0-beta.3
  * (c) 2021 kazuya kawaguchi
  * Released under the MIT License.
  */
/*!
  * vue-devtools v9.2.0-beta.3
  * (c) 2021 kazuya kawaguchi
  * Released under the MIT License.
  */
/*!
